  ...
  const sendMessage = async (content: string) => {
    ...
    try {
      ...
      const result = await streamText({
        ...
        tools: toolsObject,
        // @ts-ignore For some reason this isn't recognized as a valid option https://github.com/vercel/ai/blob/9b09f85143986636570e597c31903daf160608cd/packages/ai/core/generate-text/stream-text.ts#L134
